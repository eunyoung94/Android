...
public class ContactActivity extends AppCompatActivity {
    ...
    public void openContact(View view){
        //주소록 앱은 우리의 앱과는 다른 별도의 앱이므로, 샌드박스에 의해서 절대 내부로 접근이 불가능하다 !
        //따라서 주소록 데이터에 접근하기 위해서는 주소록 앱이 제공해주는 공개방법에 의해서만 접근할 수 있는데,
        //이 공개된 접근방법을 제공해주는 기술이 Content Provider이고, Content provider를 구현한 객체가 바로
        //ContentResolver이다
        //컨텐트 프로바이더 얻기
